...
class RelGANInstructor(BasicInstructor):
    ...
    def init_model(self):
        if cfg.gen_pretrain:
            self.log.info(
                'pretrain/image_coco/gen_MLE_pretrain_relgan_RMC_sl37_sn10000_epoch30_time202111011546_batch32_eval8.pt')
        ...
        if cfg.CUDA:
            ...
            self.vec_dis = self.dis.cuda()


    def update_temperature(self, i, N):
        self.gen.temperature,_ = get_fixed_temperature(cfg.temperature, i, N, cfg.temp_adpt)
