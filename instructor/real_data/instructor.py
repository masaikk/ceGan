...
from utils.helpers import Signal, create_logger, get_fixed_temperature, create_temp_logger
...
class BasicInstructor:
    def __init__(self, opt):
        ...
        self.temp_log = create_temp_logger(__name__+'_temp_logger', silent=False, to_disk=True,
                                           log_file=cfg.temp_log_filename if cfg.if_test
                                           else [cfg.temp_log_filename, cfg.save_root + 'temp_log.txt'])
    ...
    def cal_metrics(self, fmt_str=False):
        ...
        with torch.no_grad():
            ...
            # eval_samples = self.gen.sample(4096, 4 * cfg.batch_size)
