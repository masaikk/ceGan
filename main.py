...
def program_config(parser):
    ...
    parser.add_argument('--mu_temp',default=cfg.mu_temp,type=str)
    parser.add_argument('--fn_mu_temp',default=cfg.mu_temp,type=str)
...
if __name__ == '__main__':
    ...
    if cfg.if_real_data:
        ...
        from instructor.real_data.cegan_instructor import CeGANInstructor
