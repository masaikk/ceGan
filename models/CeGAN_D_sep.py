#
# Copyright (C), 2018-下午5:03
# FileName: CeGAN_D_sep.py
# Author:   b8313
# Date:     下午5:06 下午5:06
# Description: 
#
...
class CeGAN_vec_D(CNNDiscriminator):
    # This discriminator is only for the words vector
    # copy from relgan discriminator
    def __init__(self, embed_dim, max_seq_len, num_rep, vocab_size, padding_idx, gpu=False, dropout=0.25):
        super(CeGAN_vec_D, self).__init__(embed_dim, vocab_size, dis_filter_sizes, dis_num_filters, padding_idx,
                                       gpu, dropout)
...
class CeGAN_sen_D(CNNDiscriminator):
    def __init__(self, embed_dim, vocab_size, padding_idx, gpu=False, dropout=0.25):
        super(CeGAN_sen_D, self).__init__(embed_dim, vocab_size, dis_filter_sizes, dis_num_filters, padding_idx, gpu,
                                        dropout)


    # def forward(self, inp):
    #     # to indicate as the same output of the CeGAN_vec_D the output shape will like
    #     pass
    # I l just use the forward function in normal CNNDiscriminator
